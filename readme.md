...
Terraform Cloud executes Terraform commands on disposable virtual machines, this remote execution is also called remote operations.
 ...
 result:
   ![Terraform-loud](Images/terraform-loud.png)
...
Packer is a tool for creating identical machine images for multiple platforms from a single source configuration. Packer is lightweight, runs on every major operating system, and is highly performant, creating machine images for multiple platforms in parallel. Here is a guide on how to use Packer
...
```
  - Create a file aleed `web.pkr.hl` in the `ami` diretory, this file will contain the configuration for our tooling and wordpress ami.
